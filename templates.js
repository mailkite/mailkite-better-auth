...
/** Human-readable copy per OTP `type`, keyed by Better Auth's three values. */
const OTP_COPY = {
...
/**
 * One-time passcode. `type` is Better Auth's: sign-in | email-verification | forget-password.
 *
